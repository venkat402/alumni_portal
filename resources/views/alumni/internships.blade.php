                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <article class="single-blog-post">
                                                            ...
                                                            <div class="blog-content">
                                                                <h3><a href="/Alumni/Internships/{{$post->id}}/view">{{$post->title}}</a></h3>
                                                                <p>{!!   str_limit($post->description, $limit = 150, $end = '...') !!}</p>
                                                                <a href="/Alumni/Internships/{{$post->id}}/view" class="btn btn-brand">More</a>
                                                            </div>
                                                        </article>
                                                    </div>
